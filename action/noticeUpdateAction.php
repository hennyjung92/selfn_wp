...
<script>
    ...
    location.href="../notice_detail.php?sn_hp_bbs_no=<?=$sn_hp_bbs_no?>&sn_hp_bbs_field=<?=$sn_hp_bbs_field?>&sn_hp_bbs_file=<?=$sn_hp_bbs_file?>";
</script>
